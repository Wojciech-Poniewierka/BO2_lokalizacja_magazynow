...
class AlgorithmParameters:
    ...
    def __init__(self, population_size: int, n_generations: int, crossover_ratio: float, mutation_ratio: float,
                 equality_penalty_coefficient: float, inequality_penalty_coefficient: float, methods: List[int],
                 methods_values: List[Union[int, float]]) -> None:
        """
        Constructor
